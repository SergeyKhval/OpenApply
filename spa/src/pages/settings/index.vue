...
<template>
  <div class="flex flex-col gap-5 px-4 pt-6 pb-8">
    ...
    <RouterLink
      to="/settings/profile"
      class="flex items-center gap-3 rounded-card border border-transparent bg-card p-4 shadow-card hover:bg-muted/60 dark:border-border"
    >
      ...
      <PhCaretRight class="ml-auto shrink-0 text-muted-foreground" />
    </RouterLink>
